  ...
  return (
    <section className="px-16 md:px-9 2sm:px-5 m-auto bg-DS-beige dark:bg-DS-charcoal-950">
      <div data-aos="fade-up" className=" text-center py-10 sm:py-8">
        ...
        <h2 className="font-semibold text-2xl sm:text-lg p-2 dark:text-DS-beige">(Frequently Asked Question)</h2>
        <hr className="w-48 sm:w-32 h-1 sm:h-0.5 mx-auto mb-5 bg-DS-verdigris border-0 rounded "></hr>
      </div>

      <div data-aos="fade-up" className="space-y-4 text-lg md:text-base mb-16">
        <details className="group relative">
          <summary className="flex cursor-pointer items-center justify-between gap-1.5 bg-transparent p-4 text-DS-verdigris border-b-2 border-DS-verdigris group-open:border-b-0 dark:text-DS-beige dark:border-white">
          ...
          <p data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-gray-300 dark:border-white">
        ...
        <details className="group relative">
          ...
          <p data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-gray-300 dark:border-white">
            ...
            dari berbagai negara. IS tidak berkembang secara alami seperti bahasa isyarat nasional, tetapi dirancang untuk digunakan dalam konteks internasional. IS sering digunakan dalam pertemuan internasional, konferensi, dan acara yang
            melibatkan penutur dari berbagai negara.
          </p>
        </details>
        ...
        <details className="group relative">
          ...
          <p data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-gray-300 dark:border-white">
            Di Indonesia terdapat banyak bahasa isyarat sesuai daerahnya masing-masing, contohnya di wilayah Jakarta ada Bahasa Isyarat Jakarta (BISJAK), di Yogyakarta ada Bahasa Isyarat Yogyakarta (BISYOG), di Bali ada Bahasa Isyarat Bali
            (BISBALI), dan lainnya. Akan tetapi, terdapat dua bahasa isyarat yang umum digunakan di Indonesia yaitu Sistem Isyarat Bahasa Indonesia (SIBI) dan Bahasa Isyarat Indonesia (BISINDO).
          </p>
        </details>
        ...
        <details className="group relative">
          ...
          <p data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-gray-300 dark:border-white">
            SIBI lebih terstruktur dan formal, dikembangkan untuk tujuan pendidikan, dengan tata bahasa yang mengikuti bahasa Indonesia. Di sisi lain, BISINDO berkembang secara alami dari komunitas tunarungu, lebih fleksibel dalam struktur,
            dan lebih mencerminkan cara komunikasi sehari-hari yang digunakan oleh komunitas tunarungu. Kedua sistem ini memiliki peran dan fungsi yang berbeda dalam mendukung komunikasi dan pendidikan bagi penyandang tunarungu di
            Indonesia.
          </p>
        </details>
        ...
        <details className="group relative">
          ...
          <p data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-gray-300 dark:border-white">
            ...
            laman{" "}
            <a href="/kelas" className="font-bold hover:text-DS-orangecarrot">
              kelas
            </a>{" "}
            di Dialog Sunyi untuk mendapatkan informasi lebih lanjut mengenai kelas yang ada di daerah kamu!
          </p>
        </details>
        ...
        <details className="group relative">
          ...
          <div data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-gray-300 dark:border-white">
            ...
            <ul className="space-y-1 text-gray-700 list-disc list-inside dark:text-gray-300">
              ...
              <li className="font-bold">Kurang berlatih!</li>
            </ul>
          </div>
        </details>
