    ...
    <section className="px-16 md:px-9 2sm:px-5 m-auto bg-DS-beige dark:bg-DS-charcoal">
      ...
      <div className="space-y-4 text-lg md:text-base mb-16">
        <details className="group relative">
          ...
          <p className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-DS-beige dark:border-white">
        ...
        <details className="group relative">
          ...
          <div className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-DS-beige dark:border-white">
