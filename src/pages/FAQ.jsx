    ...
    <section className="px-16 md:px-9 2sm:px-5 m-auto bg-DS-beige dark:bg-DS-charcoal">
      ...
      <div data-aos="fade-up" className="space-y-4 text-lg md:text-base mb-16">
        <details className="group relative">
          ...
          <p data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-DS-beige dark:border-white">
        ...
        <details className="group relative">
          ...
          <div data-aos="flip-up" className="px-4 pb-4 sm:text-sm leading-relaxed text-gray-700 border-b-2 border-DS-verdigris group-open:border-t-0 dark:text-DS-beige dark:border-white">
            <p>Ya, ada beberapa kesalahan umum yang sering dilakukan oleh pemula saat menggunakan bahasa isyarat, seperti:</p>

            <ul className="space-y-1 text-gray-700 list-disc list-inside dark:text-DS-beige">
