...
const Card = ({ article }) => {
  return (
    <div className="group border border-gray-200 rounded-md shadow-md transition-all duration-300 ease-in-out overflow-hidden bg-DS-beige mb-6 mx-4">
      <img src={article.image} alt={article.name} className="image-card object-cover w-full h-48 group-hover:scale-110 transition-all duration-300 ease-in-out" loading="lazy" />
